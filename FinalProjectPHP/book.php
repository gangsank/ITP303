<?php
	...
	{
		$error = "You already have an appointment. You can only book one appointment";
	}
	else
	{
	...
	<div class="container format mt-3">
		<div class="row">
			<div class="col text-center">
				<h3>Book an Appointment</h3><hr>
			</div>
		</div>
		<form action="book_confirmation.php?" method="GET">
			<!-- Selected Doctor -->
			...
			<!-- Appointment Time -->
			<div class="row justify-content-center">
				<label for="appt-time" class="col-9 col-form-label"><strong>Time:</strong> </label>
			</div>
			<div class="row justify-content-center">
				<div class="col-9">
