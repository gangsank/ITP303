...
{
	$error = "Please fill out the time";
} 
else 
{
	require 'config.php';
	...
	$stmt = $mysqli->prepare("UPDATE appointments SET time = ? WHERE patient_id = ? AND doctor_id = ?");
	$stmt->bind_param("sii", $_GET['appt-time'], $_SESSION['id'], $_GET['doctor_id']);
	...
	<div class="container">
		<div class="row mt-4">
			<div class="col-12 text-success">
				<div class="text-success">Appointment Succeesfully Edited</div>
				<a href="main.php" role="button" class="btn btn-dark my-1">Back to main</a>
			</div> 
		</div> 
	</div>
